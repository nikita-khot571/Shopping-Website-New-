...
export declare function executeSubscription({ operation, operationName, variables, headers, embeddedIFrameElement, operationId, embedUrl, embedUrlOrigin, subscriptionUrl, protocol, httpMultipartParams, }: {
    operation: string;
    operationId: string;
